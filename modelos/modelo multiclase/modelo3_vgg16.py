...
for i, category in enumerate(category_indices):
...
#Modificaciones para aplicar Data Augmentation
...
modelo_clasificador.compile(optimizer=Adam(learning_rate=0.001),loss='categorical_crossentropy',metrics=['accuracy'])

train_generator = datagen.flow(features_train, y_train, batch_size=32)
...
modelo_clasificador.save('modelo3_vgg16.h5')
